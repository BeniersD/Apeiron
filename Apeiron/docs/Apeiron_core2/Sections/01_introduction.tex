...
work.  Section~3 gives a high‑level architectural overview.  Sections~3--6
detail the event bus, adaptive thresholds, chaos detector, and
thermodynamic cost model, respectively.  Section~7 integrates the four
modules into an end‑to‑end self‑regulation scenario.  Section~8 presents
experimental results, Section~9 discusses limitations and future directions,
