...
\begin{enumerate}
    ...
    \item On CIFAR‑10, Apeiron attains $Q = 0.43$ when provided with multi‑scale features, exceeding the theoretical target of $0.40$ and confirming the scalability of the relational hypergraph approach to natural images.
\end{enumerate}
