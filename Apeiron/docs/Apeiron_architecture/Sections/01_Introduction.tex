...
Accordingly, this document is best understood as a \emph{formal research
programme specification}: it provides a complete mathematical blueprint
for all seventeen layers, a fully implemented and validated substrate
(Cluster~I), and concrete, falsifiable hypotheses for the higher layers
