...
class SeventeenLayerFramework:
    ...
    #    }        
        return {
            "synthesis": synthesis,
            "complexity": complexity,
            "temporal_depth": len(layer8_data.get('visualisatie_buffer', [])),  # ✅ Gecorrigeerd
    ...
    def get_system_state(self) -> Dict[str, Any]:
        ...
        # Haal Layer 8 visualisatie data op
        ...
        return {
            ...
            # ✅ Vervangen: temporal_depth gebruikt nu visualisatie_buffer
