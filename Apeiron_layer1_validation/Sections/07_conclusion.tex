...
The complete source code for Layer~1 of the \Apeiron{} Framework, including all decomposition operators, the \texttt{UltimateObservable} class, the qualitative dimensions module, the relational \texttt{DensityField}, and the experiment scripts used in this paper, is available under an open-source license at \url{https://github.com/...}. The repository also includes comprehensive unit tests and performance benchmarks, enabling full replication and extension by the research community.
